...
Home page shows all the markets from the database with a brief information.
It also allows to search for markets by name, city, state or zip and
...
allows to read and add comments and ranks 
and change and delete them if you log in using password.
